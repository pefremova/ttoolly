...
class TestSomeModel(FormAddTestMixIn, FormEditTestMixIn, FormDeleteTestMixIn, TestCase):
    ...
    default_params = {'digital_field': 1.56, 'int_field': 34, 'email_field': '', 'unique_int_field': 5}
    file_fields_params = {'image_field': {'extensions': ('jpg', 'jpeg', 'png')}, 'file_field': {}}
    ...
    min_fields_length = {'digital_field': -100.5, 'int_field': -5, 'unique_int_field': 0}
    ...
    def get_error_message(self, message_type, field, *args, **kwargs):
        if (
            ...
            and message_type == 'wrong_extension'
        ):
    ...
    def setUp(self):
        ...
        self.choice_fields_values = {
            'foreign_key_field': other_model_pks,
