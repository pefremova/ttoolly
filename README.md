...
| min_fields_length | [] | Список названий полей и минимальной допустимой длины значений (для текстовых) или минимального допустимого значения (для числовых) в них | max_fields_length = (('string_field_name', 5), ('digital_field_name', -1)) | Минимальные значения. Значения меньше минимальных |
